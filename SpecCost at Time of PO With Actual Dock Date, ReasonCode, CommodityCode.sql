...
from
(select r.itemnumber, r.vendornumber, r.qtyreceived, r.purchaseprice, r.contractnumber, r.linenumber, r.releasenumber,  r.actualdockdate, r.transdate, r.porecorddate, r.recorddate, max(reasoncode) as ReasonCode, max(i.recorddate) as costrecdate from 
(select a.itemnumber, a.vendornumber, a.qtyreceived, a.purchaseprice, a.contractnumber, a.linenumber, a.releasenumber, a.actualdockdate, a.transdate, a.porecorddate, a.recorddate, h.reasoncode from merch2.[dbo].[vw_ReceiptsHistoryPODetailPurchPrice] a left join merch2.dbo.POHeader h on a.ContractNumber= h.ContractNumber) r
...
join bakery.dbo.vw_ItemMaster im on a.itemnumber = im.itemnumber
 --where a.recorddate is null
 where a.transdate  >= '20150219' --and contractnumber like '%7CL281379%'
-- and e.rdcategory is null
 group by  cal.year_445, cal.month_445, cal.week_445,a.itemnumber, a.vendornumber,a.contractnumber + ' ' + Right('00' + a.linenumber,3)+ Right('00' + a.releasenumber,3),  cast(a.actualdockdate as datetime), i.curspecmatlcost, a.purchaseprice, e.rdcategory, e.sfcategory, rd.division,v.vendorName, a.ReasonCode, im.CommodityCode
 union
